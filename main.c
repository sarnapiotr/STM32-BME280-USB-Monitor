...
int main(void) {
	...
	while (1) {
		...
		int press_frac = (int) ((pressure - press_int) * 100);

		int hum_int = (int) humidity;
		int hum_frac = (int) ((humidity - hum_int) * 100);

		sprintf(tx_buffer, "Temperature: %d.%02d C Pressure: %d.%02d hPa Humidity: %d.%02d %%\r\n", temp_int, temp_frac, press_int, press_frac, hum_int, hum_frac);
